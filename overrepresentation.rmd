...
>There is a group A that makes up 4% of a population. Within the population there is a subset X, and group A makes up 20% of that group. We would say that A is overrepresented in the subset X. How much more likely a person of group A will end up in subset X compared to someone not in group A.
